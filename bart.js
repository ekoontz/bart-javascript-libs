...
*/
    ...
    function add_trip() {
	// add one trip to the existing display.
	// create a new trip container.
	// add circle endpoint on left
	// add circle mid point (if needed)
	// add cirlcl end point on right.
	// add gradient colors for each leg of the trip.
